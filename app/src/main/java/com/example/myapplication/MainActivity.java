...
public class MainActivity extends AppCompatActivity implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener {
    ...
    private String nameAudio = "playboi carti - DIE4GUY";
    private final String link = "https://www.dropbox.com/s/brsddur8m1vxiub/Playboi%20Carti%20Die4Guy%20%283%29.mp3?dl=0";
        ...
        try {
            switch (view.getId()) {
                ...
                case R.id.btnRAW:
                    ...
                    mp = MediaPlayer.create(this, R.raw.playboicartidie4guy);
                    mp.start();
